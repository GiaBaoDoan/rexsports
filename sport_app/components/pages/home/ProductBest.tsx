...
const ProductBest = async () => {
  ...
  return (
    <div className="mx-auto max-w-6xl w-[90%] my-14">
      <article>
        <h1 className="underline text-2xl sm:text-3xl md:text-4xl font-bold mb-4 text-gray-800">
          BEST SELLER
        </h1>
        <p className="mb-6 text-gray-600 text-xs sm:text-sm md:text-base font-light">
      ...
      <div className="flex justify-center mt-10">
        <Link href={PATH.products.list}>
          <Button className="px-4 py-2 text-xs sm:px-6 sm:py-3 sm:text-sm bg-gray-900 text-white hover:bg-gray-700 transition rounded-lg">
            Xem thêm
          </Button>
        </Link>
      </div>
